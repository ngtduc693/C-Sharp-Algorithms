...
namespace Algorithms.Tests.RecommenderSystem
{
    ...
    {
        private SimilarityCalculatorBase? mockSimilarityCalculator;
        ...
        public void Setup()
        {
            mockSimilarityCalculator = new SimilarityCalculatorBase();
            recommender = new CollaborativeFiltering(mockSimilarityCalculator);
            ...
            double rating2)
        {
            ...
            var similarity = mockSimilarityCalculator?.CalculateSimilarity(user1Ratings, user2Ratings);
